...
// Form open
echo form_open_multipart(base_url('admin/kategori/tambah'),$attribut);
 ?>
...
<div class="row">
 ...
 <div class="col-md-12">
 	<div class="form-group">
 		...
 		<textarea name="deskripsi_kategori" class="form-control tinymce" placeholder="Deskripsi Kategori"><?php echo set_value('deskripsi_kategori') ?></textarea>
 	</div>
 </div>
