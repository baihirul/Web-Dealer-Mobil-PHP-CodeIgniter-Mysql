...
// Form open
echo form_open_multipart(base_url('admin/merek/tambah'),$attribut);
 ?>
...
<div class="row">
 <div class="col-md-4">
 	<div class="form-group form-group-lg">
 		...
 		<input type="text" name="nama_merek" class="form-control" placeholder="Nama Merek" value="<?php echo set_value('nama_merek') ?>" required>
 	</div>
 </div>
